...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card { background: white; border: 1px solid #E7E5E4; border-radius: 12px; margin-bottom: 20px; overflow: hidden; transition: border-color 0.1s, box-shadow 0.1s; scroll-margin-top: 20px; }
    ...
    .tab { padding: 8px 10px; font-size: 12px; font-weight: 500; color: #78716C; cursor: pointer; border-bottom: 2px solid transparent; margin-bottom: -1px; transition: all 0.1s; user-select: none; }
